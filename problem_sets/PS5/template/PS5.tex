...
\begin{enumerate}[(a)]
	...
	\vspace{1cm}	
		\lstinputlisting[language=R, firstline=42, lastline=53]{PS5CatC.R}  
	...
	\item Check for large leverage points by plotting the $h$ values.
		\lstinputlisting[language=R, firstline=55, lastline=61]{PS5CatC.R}  
		\vspace{1cm}
	
	\begin{figure}[h!]
		\includegraphics[width=\linewidth]{PS52}
		\caption{ h value plot.}
		\label{fig:PS52}
	\end{figure}	
	\vspace{1cm}
	...
	\lstinputlisting[language=R, firstline=63, lastline=71]{PS5CatC.R}  
	\vspace{1cm}
	
	\item Check for influential points by creating a "Bubble plot" with the hat-values and studentized residuals.
		\lstinputlisting[language=R, firstline=73, lastline=80]{PS5CatC.R}  
	\vspace{1cm}
	
	\begin{figure}[h!]
		\includegraphics[width=\linewidth]{PS53}
		\caption{Bubble plot.}
		\label{fig:PS53}
	\end{figure}	
	\vspace{1cm}
