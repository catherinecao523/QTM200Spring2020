...
\begin{enumerate}
	...
	Calculate the $\chi^2$ test statistic by hand (even better if you can do "by hand" in \texttt{R}).\\
		...
		\vspace{1cm}
	\lstinputlisting[language=R, firstline=1, lastline=10]{PS2CatC.R}  
	\vspace{.5cm}
	...
	\vspace{1cm}
\lstinputlisting[language=R, firstline=11, lastline=15]{PS2CatC.R}  
\vspace{.5cm}
	...
	\item [(d)] How might the standardized residuals help you interpret the results?  
		...
		\vspace{1cm}
	\lstinputlisting[language=R, firstline=16, lastline=28]{PS2CatC.R}  
	\vspace{.5cm}
...
\begin{enumerate}
	\item [(a)] State a null and alternative (two-tailed) hypothesis. 
		...
		\vspace{1cm}
	\lstinputlisting[language=R, firstline=30, lastline=32]{PS2CatC.R}  
	\vspace{.5cm}
	...
	\lstinputlisting[language=R, firstline=31, lastline=45]{PS2CatC.R}  
	...
	\item [(c)] Interpret the coefficient estimate for reservation policy. 
		...
		\vspace{1cm}
	\lstinputlisting[language=R, firstline=46, lastline=47]{PS2CatC.R}  
	\vspace{.5cm}
...
\begin{enumerate}
	...
	\vspace{1cm}
\lstinputlisting[language=R, firstline=49, lastline=56]{PS2CatC.R}  
\vspace{.5cm}
...
\newpage
	...
	\vspace{1cm}
\lstinputlisting[language=R, firstline=57, lastline=62]{PS2CatC.R}  
\vspace{.5cm}
	...
	\vspace{1cm}
\lstinputlisting[language=R, firstline=63, lastline=67]{PS2CatC.R}  
\vspace{.5cm}
	...
	\vspace{1cm}
\lstinputlisting[language=R, firstline=68, lastline=71]{PS2CatC.R}  
\vspace{.5cm}
...
\newpage
	...
	\end{itemize}
		...
		\vspace{1cm}
	\lstinputlisting[language=R, firstline=72, lastline=85]{PS2CatC.R}  
	\vspace{.5cm}
	...
	\item Use the \texttt{predict()} function in \texttt{R} to (1) predict an individual fruitfly's lifespan when \texttt{thorax}=0.8 and (2) the average \texttt{lifespan} of fruitflies when \texttt{thorax}=0.8 by the fitted model. This requires that you compute prediction and confidence intervals. What are the expected values of lifespan? What are the prediction and confidence intervals around the expected values? 
		...
		\vspace{1cm}
	\lstinputlisting[language=R, firstline=86, lastline=96]{PS2CatC.R}  
	\vspace{.5cm}
	...
	\vspace{1cm}
\lstinputlisting[language=R, firstline=97, lastline=114]{PS2CatC.R}  
\vspace{.5cm}

	\begin{figure}
	\includegraphics[width=\linewidth]{PS21}
	\caption{Lifespan vs Thorax.}
	\label{fig:PS21}

	\includegraphics[width=\linewidth]{PS22}
	\caption{Fitted Linear Model of lifespan vs thorax.}
	\label{fig:PS22}
\end{figure}	
